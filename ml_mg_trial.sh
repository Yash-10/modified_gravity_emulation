...
pwd
cd /cosma5/data/durham/dc-gond1/pix2pix_modified_gravity/pytorch-CycleGAN-and-pix2pix
ls /cosma5/data/durham/dc-gond1/official_pix2pix_data_F5n1_GR/train | wc -l
ls /cosma5/data/durham/dc-gond1/official_pix2pix_data_F5n1_GR/val | wc -l
ls /cosma5/data/durham/dc-gond1/official_pix2pix_data_F5n1_GR/test | wc -l

python3 train.py --dataset_mode aligned --dataroot /cosma5/data/durham/dc-gond1/official_pix2pix_data_F5n1_GR --name pix2pix_F5n1_GR_DEN_a1_RESIDUAL_BUT_SCALED_LOGARITHM_TRANSFORM_NORMALIZED_BY_10_Focal_Freq_Loss_and_L1_Patch4_and_NEW_MODIFIED_MODIFIED --model pix2pix --direction AtoB \
