...
from calculate_scalar_field import get_screening_map
...
for epoch_num in [40]:
    ...
    chisquare_ip_gt_median, chisquare_gen_gt_median, chisquare_ip_gt, chisquare_gen_gt, chisquare_ip_gt_PDF, chisquare_gen_gt_PDF = driver(val_gen, val_ip, val_gt, vel_field=False, name=name, val_or_test=1, epoch_num=epoch_num,field_name='F6_den_latent_interp', save=True)
