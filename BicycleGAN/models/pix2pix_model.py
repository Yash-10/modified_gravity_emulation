...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_G = torch.optim.AdamW(self.netG.parameters(), lr=opt.lr, betas=(opt.beta1, 0.999))
    ...
    def backward_G(self):
        ...
        self.loss_G_L1 = self.opt.lambda_L1 * 0.5 * (self.criterionL1(self.fake_B, self.real_B) + self.criterionFFL(self.fake_B, self.real_B))  # Multiply by 0.5 to make the loss range same of only L1 in the original implementation.
        # combine loss and calculate gradients
